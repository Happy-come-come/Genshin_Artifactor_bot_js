...
def generation(data):
    ...
    D.text((1760,1060),f'UID: {str(Uid)}',font=config_font(18),fill=(256,256,256,256))
...
input_json = base64.b64decode(sys.argv[1]).decode()
generation(json.loads(input_json))
